...
"""
LAN-Link - All-in-One Edition with Direct Client-to-Client P2P File Sharing
...
class ChatApp:
    ...
    def _build_home_frame(self):
        ...
        ttk.Label(self.home_frame, text="made by Daniel Cave", font=("", 9, "italic"), foreground="gray").pack(pady=(0, 15))
